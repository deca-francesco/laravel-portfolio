...
<form action="{{ route('projects.store') }}" method="POST" class="text-light">
    @csrf
    {{-- csrf è il token di autenticazione di laravel che controlla che la chiamata provenga da un form suo e dal tuo
    pc, browser ecc --}}
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="date" class="form-control" name="started" id="started" required>
    </div>
    <div class="mb-3">
    ...
    <div><button type="submit" class="btn btn-primary">Salva progetto</button></div>
</form>
